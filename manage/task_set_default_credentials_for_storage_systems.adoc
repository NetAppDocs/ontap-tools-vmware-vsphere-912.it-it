...
+
Vedere link:..configure/task_configure_user_role_and_privileges.html["Configurare i ruoli e i privilegi degli utenti"]
 Nella sezione _Strumenti ONTAP per la documentazione di VMware vSphere_.
